...
const pedido = z.object({
    ...
    status: z.enum(["Em andamento", "Completado", "Cancelado"], "O status deve ser um de: Em andamento, Completado, Cancelado"),
    ...
    products: z.array(z.uuid("Formato de ID de produto inválido")).min(1, "É necessário pelo menos um produto"),
});
