  ...
  return (
    <div className="w-full h-full flex flex-row justify-center items-center bg-black">
        <div className="flex flex-col w-full h-[1600px] bg-[#F5F5F5] border-white box-border items-center overflow-hidden">
            ...
            <div className="absolute w-full top-[605px] h-[772px] flex flex-col">

                <div className="flex flex-col pl-[7%]">
                    <hr className=" absolute w-5/6 border-[#B9B9B9] border-1"></hr>
                ...
                <div className="pl-[7%]">
                    <hr className="w-5/6 border-[#B9B9B9] border-1 mt-7"></hr>
                    <p className="font-medium mt-4 mb-2">Produtos em destaque</p>
                </div>

                <div className="flex flex-row overflow-x-auto w-full pl-[7%]">
